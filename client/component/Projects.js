      ...
      <div id="big-box">
        <div className="box-project">
          ...
          <ul className="project">
            ...
            <li>
              Spearheaded the use of Bootstrap-React Modal and Alert components
              to make our page look clean and professional.
            </li>
          </ul>
          <div
            style={{
        ...
        <div className="box-project">
          ...
          <p className="project">
            In a group of three, we were asked to create an e-commerce website.
            We were given only a week to finish this project. It is the first
            ever web application we have made while in Fullstack Academy.
          </p>
          <p className="project">
          ...
          <ul className="project">
            ...
            <li>
              Designed back-end routes and created a single view where a user
              can see their profile and edit their information.
            </li>
            <li>
